...
Most programmers and most computer languages will readily agree that this expression is perfectly valid, but if you show it to a mathematician, be ready to hear "no, it isn't". And once you see what makes him think so, you will see why we assign values with `:` in k. A different perspective is not necessarily wrong, and there is nothing wrong if it becomes your own — and that is the right mindset to approach k. 
